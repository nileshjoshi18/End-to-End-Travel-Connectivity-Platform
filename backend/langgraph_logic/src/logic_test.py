...
def find_trains(start_stop: str, end_stop: str, user_time_str: str) -> list[dict]:
    ...
    result = df_filtered.sort_values('stop_dep_mins_adj').head(3)
    ...
    return [
        {
            ...
            "line":      determine_line(start_stop),
        }
...
if __name__ == "__main__":
    # print(changeover_routes('VER_MLN1', 'JGN_MLN1'))
    print(find_trains('PAN_HR','VAS_HR','20:00'))